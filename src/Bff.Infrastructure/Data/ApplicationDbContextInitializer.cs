...
public class ApplicationDbContextInitializer
{
    ...
    public async Task TrySeedAsync()
    {
                ...
                RedirectUris =
                    {
                        ...
                        new Uri("http://localhost:4200/signin-callback.html"),
                        new Uri("http://localhost:4200/signin-silent-callback.html"),
                        new Uri("https://active.trueconnect.io.vn/index.html"),
                        new Uri("https://active.trueconnect.io.vn/signin-callback.html"),
                        new Uri("https://active.trueconnect.io.vn/signin-silent-callback.html"),
                    },
                Permissions =
                    {
                        ...
                        Permissions.Prefixes.Scope + "true"
                    },
                Requirements =
                    {
        ...
        if (await _managerScope.FindByNameAsync("api") is null)
        {
            ...
            {
                DisplayName = "Active+ API access",
                DisplayNames =
                    {
                        [CultureInfo.GetCultureInfo("vi-VN")] = "Active+ API."
                    },
                Name = "api",
                Resources =
                    {
